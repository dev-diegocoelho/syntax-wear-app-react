...
const categories = [
    ...
    {
        name: "Esportivo", image: tenisEsportivo
    },
    {
...
export const Categories = () => {
    return (
        <section className='container flex gap-2.5 lg:grid lg:grid-cols-4 lg:gap-4 mb-10 overflow-x-auto scrollar-hide snap-x snap-mandatory'>
