...
function RouteComponent() {
    ...
    if (!filteredProduct)
        return (
            <section className='container mb-10 pt-44 md:pt54 pb-10 md:px-10 text-center text-black min-h-[80vh] flex flex-col items-center justify-center'>
    ...
    const inInstallmentsPrice = originalPrice / 6; // Dividindo o preço original em 6 parcelas
        ...
        <div className='flex justify-center gap-10'>
            ...
            <div className='text-black'>
                ...
                <p className='text-sm text-[#878787]'>Você economiza:
                    <span className='font-semibold'>10%
                    </span>
                </p>
                <p className='mb-2'>ou <span className='text-[#38373a] font-semibold'>6X</span> de{" "}<span className='text-[#38373a font-semibold'> {formatCurrency(inInstallmentsPrice)}
                </span>
                </p>
